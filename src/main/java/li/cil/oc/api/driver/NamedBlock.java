 ...
 * other  CompletableFuture<block> driversAsync(interface based drivers such as for <tt>IInventory</tt>).
 * <p/>
...
public interface NamedBlock {
     ...
     */  CompletableFuture<String> preferredNameAsync();
     ...
     */  CompletableFuture<int> priorityAsync();
}
