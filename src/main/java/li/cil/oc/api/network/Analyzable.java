...
public interface Analyzable {
     ...
     * player's chat when the analyzer  CompletableFuture<is> usedAsync(or do whatever) and may also be
     ...
     *  CompletableFuture<main> nodeAsync(i.e. <tt>this.node()</tt>).
     */  CompletableFuture<Node[]> onAnalyzeAsync(PlayerEntity player, Direction side, float hitX, float hitY, float hitZ);
}
