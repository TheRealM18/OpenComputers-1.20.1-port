 ...
 * for example because you have no direct control over  CompletableFuture<the> blockAsync(e.g. what we
 * do with the command block).
 * <p/>
 * You should <em>not</em> implement this interface in your tile entities, or
 * weird things  CompletableFuture<may> happenAsync(e.g. update and save/load being called multiple
 * times).
 */
public interface ManagedEnvironment extends Environment, Persistable {
     ...
     */  CompletableFuture<boolean> canUpdateAsync();
